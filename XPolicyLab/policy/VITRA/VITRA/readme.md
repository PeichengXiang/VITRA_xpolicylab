...
fov = torch.tensor([[np.deg2rad(60.0), np.deg2rad(60.0)]], dtype=torch.float32)      # input your camera FOV here [fov_x, fov_y]
...
state = np.zeros((normalizer.state_mean.shape[0],), dtype=np.float32)             # Input your hand state here
